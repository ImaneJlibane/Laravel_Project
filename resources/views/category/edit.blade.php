        ...
        <div class="col-span-1">
            ...
            <div class="bg-white shadow-md rounded-md">
                <div class="bg-gray-200 px-4 py-3 border-b border-gray-300">
                    <h4 class="text-lg font-semibold">Edit Categories
                ...
                <div class="px-4 py-3">
                    <form action="{{ url('categories/'.$category->id.'/edit') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="name" name="name" class="form-input w-full rounded-md" value="{{ $category->name }}" />
                            @error('name') <span class="text-red-500">{{ $message }}</span> @enderror
                        </div>
                        <div class="mb-4">
                            <label for="description" class="block">Description</label>
                            <textarea id="description" name="description" class="form-textarea w-full rounded-md" rows="3">{{ $category->description }}</textarea>
